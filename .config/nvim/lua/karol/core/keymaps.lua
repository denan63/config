...
keymap.set("", "<leader>n", "", { desc = "Search" }) -- description for which-key
...
keymap.set("", "<leader>s", "", { desc = "Split" }) -- description for which-key
...
keymap.set("", "<leader>t", "", { desc = "Tabs" }) -- description for which-key
